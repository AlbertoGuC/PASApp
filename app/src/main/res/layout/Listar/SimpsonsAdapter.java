...
public class SimpsonsAdapter extends RecyclerView.Adapter<SimpsonsAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public SimpsonsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View cview = LayoutInflater.from(parent.getContext()).inflate(R.layout.row,parent,false);
        return new ViewHolder(cview);
    }

    @Override
    public void onBindViewHolder(@NonNull SimpsonsAdapter.ViewHolder holder, int position) {
